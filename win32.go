// win32相关API调用、常量标识和结构类
// 部分已注释，其他相关含义可去微软文档查找：https://learn.microsoft.com/zh-cn/windows/win32/
package gowin
...
const (
	...
	WM_RBUTTONUP       = 0x0205
	WM_USER            = 0x0400
	WM_TRAY_NOTIFYICON = WM_USER + 1
	WM_CLOSE           = 0x0010
	WM_CREATE          = 0x0001
	WM_SYSCOMMAND      = 0x0112 // 当用户选择“最大化”按钮、最小化按钮、还原按钮或关闭按钮时，窗口会收到此消息
